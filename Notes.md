...
1. Accessibility & keyboarding: Provide focus outlines, aria-live regions for new chat messages, and keyboard shortcuts (e.g., / to jump to search, Ctrl+Enter to send). Also ensure contrast ratios meet WCAG.
...
1. Search UX polish: Add debounce to reduce re-renders on every keystroke, show match counts, and keep filters per page instead of clearing when switching tabs.
